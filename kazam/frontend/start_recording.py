...
from kazam.frontend.widgets.comboboxes import VideoCombobox, AudioCombobox, CodecCombobox
...
class RecordingStart(KazamStage):
    ...
    def get_selected_codec(self):
        return self.combobox_codec.get_selected_codec()
